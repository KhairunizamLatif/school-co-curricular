                                    ...
                                    <hr>
                                        ...
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <input min="0" max="18" type="number" required="required"
                                                       class="form-control"
                                                       id="a"
                                                       placeholder="Enter Attendance student"/>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-striped table-hover">
                                            <tr align="center">
                                                ...
                                                <td><input type="checkbox" name="komitmen1" class="checkbox" id="150" value="3">
                                                    <label for="150">03 </label></td>
                                                <td align="left">Mengemas Peralatan</td>
                                                <td><input type="checkbox" name="komitmen2" class="checkbox" id="151" value="2">
                                                    <label for="151">02 </label></td>
                                                <td align="left">Mencuba</td>
                                                <td><input type="checkbox" name="komitmen3" class="checkbox" id="152" value="2">
                                                    <label for="152">02 </label></td>
                                            </tr>
                                            <tr align="center">
                                                <td align="left">Menguruskan Aktviti</td>
                                                <td><input type="checkbox" name="komitmen4" class="checkbox" id="153" value="3">
                                                    <label for="153">03</label></td>
                                                <td align="left">Menepati Waktu</td>
                                                <td><input type="checkbox" name="komitmen5" class="checkbox" id="154" value="2">
                                                    <label for="154">02 </label></td>
                                                <td align="left">Mem. Kerjasama</td>
                                                <td><input type="checkbox" name="komitmen6" class="checkbox" id="155" value="2">
                                                    <label for="155">02 </label></td>
                                            </tr>
                                            <tr align="center">
                                                <td align="left">Membantu Guru / Rakan</td>
                                                <td><input type="checkbox" name="komitmen7" class="checkbox" id="156" value="2">
                                                    <label for="156">02 </label></td>
                                                <td align="left">Menunjukkan Minat</td>
                                                <td><input type="checkbox" name="komitmen8" class="checkbox" id="157" value="2">
                                                    <label for="157">02 </label></td>
                                                <td align="left">Nilai Murni&nbsp;</td>
                                                <td><input type="checkbox" name="komitmen9" class="checkbox" id="158" value="2">
                                                    <label for="158">02 </label></td>
                                            </tr>
                                            <tr align="center">
                                                <td align="left">Menyediakan Peralatan</td>
                                                <td><input type="checkbox" name="komitmen10" class="checkbox" id="159" value="2">
                                                    <label for="159">02 </label></td>
                                                <td align="left">Menunjukkan Kesungguhan</td>
                                                <td><input type="checkbox" name="komitmen11" class="checkbox" id="160" value="2">
                                            ...
                                            <tr align="center">
                                                ...
                                                <td><input type="checkbox" name="komitmen12" class="checkbox" id="161" value="2">
                                                    <label for="161">02 </label></td>
                                                <td align="left">Mengikut Arahan</td>
                                                <td><input type="checkbox" name="komitmen13" class="checkbox" id="162" value="2">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" name="km" class="form-control" id="km" maxlength="10" value="">
                                        </div>
                                        <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next
                                        </button>
                                    </div>
